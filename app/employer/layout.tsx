...
export default function EmployerLayout({
  ...
  return (
    <div className="landing-page flex-1 h-full min-h-0 w-full overflow-y-auto flex flex-col" style={{ background: "linear-gradient(135deg, var(--navy) 0%, #1a2d6d 50%, var(--crimson) 100%)" }}>
